...
.field private static VOICE_ASSISTANT_ACTION:Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRunQuickPowerOn:Z
...
.method private execQuickPoweron()V
    ...
    invoke-static {v0}, Lcom/android/internal/policy/Powerstate;->restoreSensorState(Landroid/content/Context;)V

    iput-boolean v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->isFastPowerinRun:Z
...
.method private handleAppSwitchEvent()V
    ...
    .prologue
    sget-boolean v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mUsingHwNavibar:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->showOrHideRecentAppsDialog(I)V
...
.method public finishAnimationLw()I
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardSubWindow:Landroid/view/WindowManagerPolicy$WindowState;
...
.method handleVolumeKeyForOtherStream(II)V
    .locals 1
    .parameter "keyCode"
    .parameter "flags"

    .prologue
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isVoiceHelperActive()Z
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->handleVolumeKey(II)V
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    :cond_3
    const-string v32, "ro.config.keypasstouser"
...
.method public interceptKeyBeforeQueueingCore(Landroid/view/KeyEvent;IZ)I
    ...
    iget-object v13, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardMediator:Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;
    ...
    invoke-virtual {v13}, Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual {v13}, Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;->isShowing()Z
    ...
    invoke-direct {v0, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isWakeKeyFun(I)Z
    ...
    iget-object v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardMediator:Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;
    ...
    :goto_6
    invoke-virtual {v14, v8, v13}, Lcom/android/internal/policy/impl/MiuiKeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(IZ)Z
    ...
    invoke-virtual {v0, v8, v11}, Lcom/android/internal/policy/impl/PhoneWindowManager;->handleVolumeKeyForOtherStream(II)V
    ...
    const-string v13, "phone_msim"

    invoke-static {v13}, Landroid/os/ServiceManager;->checkService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v13

    invoke-static {v13}, Lcom/android/internal/telephony/msim/ITelephonyMSim$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/msim/ITelephonyMSim;

    move-result-object v12

    .local v12, telephonyService:Lcom/android/internal/telephony/msim/ITelephonyMSim;
    if-eqz v12, :cond_1e
    ...
    invoke-virtual {v13}, Landroid/telephony/MSimTelephonyManager;->getPhoneCount()I

    move-result v13

    if-ge v5, v13, :cond_1e

    invoke-interface {v12, v5}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->isRinging(I)Z

    move-result v13

    if-eqz v13, :cond_1d

    invoke-interface {v12}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->silenceRinger()V
    ...
    invoke-interface {v12, v5}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->isOffhook(I)Z

    move-result v13

    if-eqz v13, :cond_1c

    invoke-interface {v12, v5}, Lcom/android/internal/telephony/msim/ITelephonyMSim;->endCall(I)Z
    :try_end_4
    ...
    const-string v14, "ITelephonyMSim threw RemoteException"

    invoke-static {v13, v14, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .end local v3           #ex:Landroid/os/RemoteException;
    .end local v5           #i:I
    .end local v12           #telephonyService:Lcom/android/internal/telephony/msim/ITelephonyMSim;
    :cond_1e
    :goto_c
    if-eqz p3, :cond_1f
...
.method isVoiceHelperActive()Z
    ...
    const-string v2, "isVoiceHelperActive: couldn\'t get AudioManager reference"
    ...
    :cond_0
    invoke-virtual {v0}, Landroid/media/AudioManager;->isVoiceHelperActive()Z
...
.method public layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    .local v23, isNeedHideNaviBarWin:Z
    :goto_2
    move-object/from16 v0, p0
    ...
    .end local v23           #isNeedHideNaviBarWin:Z
    ...
    .restart local v23       #isNeedHideNaviBarWin:Z
    :cond_6
    const/16 v22, 0x0
...
.method shouldStopKeyWhenQuickPoweron(ZI)Z
    ...
    invoke-direct {v1, p0, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager$14;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Ljava/lang/String;)V
