...
.method public run()V
    ...
    invoke-static {v3, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_48
    .catch Ljava/lang/Throwable; {:try_start_48 .. :try_end_48} :catch_38
    ...
    invoke-static {v3, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_4b
    .catch Ljava/lang/Throwable; {:try_start_4b .. :try_end_4b} :catch_37
    ...
    .end local v73           #lastAirplaneMode:I
    :cond_f
    :goto_40
    ...
    .restart local v73       #lastAirplaneMode:I
    :cond_1e
    :try_start_58
    invoke-virtual {v4}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .local v110, userChangeAirplane:I
    const/4 v3, -0x1
    ...
    .end local v73           #lastAirplaneMode:I
    .end local v110           #userChangeAirplane:I
    :catch_35
    move-exception v66
    ...
    .end local v66           #e:Ljava/lang/Throwable;
    .restart local v73       #lastAirplaneMode:I
    .restart local v110       #userChangeAirplane:I
    :cond_1f
    const/4 v3, 0x0
