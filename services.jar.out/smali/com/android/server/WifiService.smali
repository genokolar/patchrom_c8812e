...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v5, p0, Lcom/android/server/WifiService;->mScanCount:Ljava/util/HashMap;
    ...
    iput-object v10, p0, Lcom/android/server/WifiService;->mLatch:Ljava/util/concurrent/CountDownLatch;
...
.method static synthetic access$2300(Lcom/android/server/WifiService;)Ljava/util/concurrent/CountDownLatch;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/WifiService;->mLatch:Ljava/util/concurrent/CountDownLatch;
...
.method private registerForBroadcasts()V
    ...
    const-string v1, "android.net.cw.QUIT"
...
.method public requestCpluswStop()V
    .locals 6

    .prologue
    const-string v2, "WifiService"

    const-string v3, "requestCpluswStop"
    ...
    iput-object v2, p0, Lcom/android/server/WifiService;->mLatch:Ljava/util/concurrent/CountDownLatch;

    new-instance v0, Landroid/content/Intent;

    const-string v2, "android.net.wifi.WIFI_STATE_WILL_STOP"
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/WifiService;->mLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    const-string v3, "requestCpluswStop exception"
