...
.field private mGlobalMode:Lcom/android/internal/telephony/msim/MSimHWGlobalMode;
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/uicc/UiccController;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->mGlobalMode:Lcom/android/internal/telephony/msim/MSimHWGlobalMode;

    const-string v2, "ro.config.cdma.globalMode"

    invoke-static {v2, v7}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->bSupportGlobalMode:Z
    ...
    invoke-virtual {v2, p0, v5, v6}, Lcom/android/internal/telephony/uicc/UiccController;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-direct {v3, p0, v6}, Lcom/android/internal/telephony/msim/CardSubscriptionManager$CardInfo;-><init>(Lcom/android/internal/telephony/msim/CardSubscriptionManager;Lcom/android/internal/telephony/uicc/UiccCard;)V
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->bSupportGlobalMode:Z

    if-eqz v2, :cond_3

    invoke-static {p1}, Lcom/android/internal/telephony/msim/MSimHWGlobalMode;->getInstance(Landroid/content/Context;)Lcom/android/internal/telephony/msim/MSimHWGlobalMode;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->mGlobalMode:Lcom/android/internal/telephony/msim/MSimHWGlobalMode;
...
.method private isValidSubDatas()Z
    .locals 4
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->getCardSubscriptions(I)Lcom/android/internal/telephony/msim/SubscriptionData;
    ...
    .restart local v0       #cardInfo:Lcom/android/internal/telephony/msim/CardSubscriptionManager$CardInfo;
    :cond_0
...
.method private declared-synchronized onUpdateUiccStatus(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    .local v8, cardState:Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    move-object/from16 v0, p0
    ...
    .local v15, uiccCard:Lcom/android/internal/telephony/uicc/UiccCard;
    const/4 v7, 0x0
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/msim/CardSubscriptionManager$CardInfo;->getUiccCard()Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->bSupportGlobalMode:Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->isValidSubDatas()Z
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->mGlobalMode:Lcom/android/internal/telephony/msim/MSimHWGlobalMode;

    move-object/from16 v18, v0

    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/msim/MSimHWGlobalMode;->validateGlobalMode()Z
    ...
    :cond_8
    :try_start_3
    invoke-virtual {v15}, Lcom/android/internal/telephony/uicc/UiccCard;->getCardState()Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    ...
    .local v12, numApps:I
    sget-object v18, Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;->CARDSTATE_PRESENT:Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;

    move-object/from16 v0, v18

    if-ne v8, v0, :cond_9

    invoke-virtual {v15}, Lcom/android/internal/telephony/uicc/UiccCard;->getNumApplications()I
    ...
    invoke-virtual {v15, v4}, Lcom/android/internal/telephony/uicc/UiccCard;->getApplicationIndex(I)Lcom/android/internal/telephony/uicc/UiccCardApplication;

    move-result-object v16

    .local v16, uiccCardApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    invoke-virtual/range {p1 .. p1}, Ljava/lang/Integer;->intValue()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getAid()Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getAppLabel()Ljava/lang/String;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getType()Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    move-result-object v14

    .local v14, type:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lcom/android/internal/telephony/msim/CardSubscriptionManager;->appTypetoString(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;)Ljava/lang/String;
    ...
    :goto_4
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getState()Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;

    move-result-object v18

    sget-object v19, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;->APPSTATE_READY:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppState;
    ...
    .end local v8           #cardState:Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    ...
    .end local v14           #type:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    .end local v15           #uiccCard:Lcom/android/internal/telephony/uicc/UiccCard;
    .end local v16           #uiccCardApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    :catchall_0
    move-exception v18
    ...
    .restart local v8       #cardState:Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;
    .restart local v12       #numApps:I
    .restart local v15       #uiccCard:Lcom/android/internal/telephony/uicc/UiccCard;
    :cond_d
    const/4 v6, 0x1
