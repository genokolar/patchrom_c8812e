...
.method private processAllDataDisconnected(Landroid/os/AsyncResult;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/msim/SubscriptionManager;->getCurrentSubscriptionStatus(Lcom/android/internal/telephony/msim/SubscriptionManager$SubscriptionId;)Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;
    ...
    const-string v3, ", not send deactivated notify"
...
.method private processCardInfoAvailable(Landroid/os/AsyncResult;)V
    ...
    iget v11, v9, Lcom/android/internal/telephony/msim/Subscription;->slotId:I
    ...
    iget-boolean v10, p0, Lcom/android/internal/telephony/msim/SubscriptionManager;->mAllCardsStatusAvailable:Z

    if-nez v10, :cond_8

    const-string v10, "Global Mode, wait until allCardInfo Avaailable events received!"
...
.method public setSubscription(Lcom/android/internal/telephony/msim/SubscriptionData;)Z
    ...
    const-string v10, "setSubscription :"
    ...
    invoke-virtual {v9, v10}, Lcom/android/internal/telephony/msim/Subscription;->equals(Lcom/android/internal/telephony/msim/Subscription;)Z
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/msim/SubscriptionManager;->getCurrentSubscriptionStatus(Lcom/android/internal/telephony/msim/SubscriptionManager$SubscriptionId;)Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;
    ...
    invoke-virtual {v9, v10}, Lcom/android/internal/telephony/msim/Subscription;->isSame(Lcom/android/internal/telephony/msim/Subscription;)Z

    move-result v9

    if-eqz v9, :cond_3

    const-string v9, "already activated, return success directly!"
    ...
    const-string v11, "ACTIVATE SUCCESS"
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/msim/SubscriptionManager;->notifySubscriptionActivated(I)V
    ...
    const-string v9, "already Deactivated, return success directly!"
    ...
    const-string v11, "DEACTIVATE SUCCESS"
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/msim/SubscriptionManager;->notifySubscriptionDeactivated(I)V
    ...
    iget-object v9, v9, Lcom/android/internal/telephony/msim/Subscription;->subStatus:Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;

    sget-object v10, Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;->SUB_INVALID:Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;
    ...
    const-string v10, "Need to deactivate current SUB :"
    ...
    new-instance v5, Lcom/android/internal/telephony/msim/Subscription;

    invoke-direct {v5}, Lcom/android/internal/telephony/msim/Subscription;-><init>()V

    .local v5, newSub:Lcom/android/internal/telephony/msim/Subscription;
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/msim/SubscriptionManager;->getCurrentSubscription(Lcom/android/internal/telephony/msim/SubscriptionManager$SubscriptionId;)Lcom/android/internal/telephony/msim/Subscription;

    move-result-object v9

    invoke-virtual {v5, v9}, Lcom/android/internal/telephony/msim/Subscription;->copyFrom(Lcom/android/internal/telephony/msim/Subscription;)Lcom/android/internal/telephony/msim/Subscription;

    sget-object v9, Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;->SUB_DEACTIVATE:Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;

    iput-object v9, v5, Lcom/android/internal/telephony/msim/Subscription;->subStatus:Lcom/android/internal/telephony/msim/Subscription$SubscriptionStatus;

    iget-object v9, p0, Lcom/android/internal/telephony/msim/SubscriptionManager;->mDeactivatePending:Ljava/util/HashMap;

    invoke-virtual {v9, v7, v5}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .end local v5           #newSub:Lcom/android/internal/telephony/msim/Subscription;
    :cond_5
    :goto_3
    iget-object v9, p1, Lcom/android/internal/telephony/msim/SubscriptionData;->subscription:[Lcom/android/internal/telephony/msim/Subscription;
    ...
    const-string v10, "Need to activate new SUB : "
    ...
    .restart local v5       #newSub:Lcom/android/internal/telephony/msim/Subscription;
    iget-object v9, p1, Lcom/android/internal/telephony/msim/SubscriptionData;->subscription:[Lcom/android/internal/telephony/msim/Subscription;
    ...
    const-string v9, "send setSubscription completed event 2!"
    ...
    .local v2, deactivateInProgress:Z
    if-eqz v2, :cond_d

    iput-boolean v8, p0, Lcom/android/internal/telephony/msim/SubscriptionManager;->mSetSubscriptionInProgress:Z

    .end local v2           #deactivateInProgress:Z
    :cond_b
    :goto_4
    ...
    .restart local v2       #deactivateInProgress:Z
    :cond_d
    invoke-direct {p0}, Lcom/android/internal/telephony/msim/SubscriptionManager;->processActivateRequests()V
