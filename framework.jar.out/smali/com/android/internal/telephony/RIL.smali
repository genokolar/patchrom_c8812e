...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/RIL$RILEx;,
...
.field private mRILEx:Lcom/android/internal/telephony/RIL$RILEx;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/RIL;->isHwDSDAEnabled:Z
    ...
    sput-object v0, Lcom/android/internal/telephony/RIL;->hwDSDSMode:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;IILjava/lang/Integer;)V
    ...
    new-instance v5, Lcom/android/internal/telephony/RIL$RILEx;

    const/4 v6, 0x0

    invoke-direct {v5, p0, v6}, Lcom/android/internal/telephony/RIL$RILEx;-><init>(Lcom/android/internal/telephony/RIL;Lcom/android/internal/telephony/RIL$1;)V

    iput-object v5, p0, Lcom/android/internal/telephony/RIL;->mRILEx:Lcom/android/internal/telephony/RIL$RILEx;
    ...
    const-string v5, "Not starting RILReceiver: basebandless target"
    ...
    const-string v5, "android.intent.action.ACTION_RILD_START"
...
.method static synthetic access$1200(Lcom/android/internal/telephony/RIL;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400()Ljava/lang/String;
    ...
    .prologue
    sget-object v0, Lcom/android/internal/telephony/RIL;->hwDSDSMode:Ljava/lang/String;
...
.method static synthetic access$500()Z
    ...
    .prologue
    sget-boolean v0, Lcom/android/internal/telephony/RIL;->isHwDSDAEnabled:Z
...
.method private broadcastWifiChannelsChangedIntent([B)V
    ...
    const-string v4, "android.intent.action.SAFE_WIFI_CHANNELS_CHANGED"
...
.method private processUnsolOemhookResponse(Ljava/nio/ByteBuffer;)V
    ...
    .local v5, QCRILHOOK_BASE:I
    const v10, 0x803e8

    .local v10, QCRILHOOK_UNSOL_EXTENDED_DBM_INTL:I
    const v6, 0x803e9

    .local v6, QCRILHOOK_UNSOL_CDMA_BURST_DTMF:I
    const v7, 0x803ea

    .local v7, QCRILHOOK_UNSOL_CDMA_CONT_DTMF_START:I
    const v8, 0x803eb

    .local v8, QCRILHOOK_UNSOL_CDMA_CONT_DTMF_STOP:I
    const v11, 0x803f0

    .local v11, QCRILHOOK_UNSOL_WIFI_SAFE_CHANNELS_CHANGED:I
    const v4, 0x807d0

    .local v4, HW_QCRILHOOK_BASE:I
    const v9, 0x807d1

    .local v9, QCRILHOOK_UNSOL_DIALUP_STATE:I
    const/4 v15, 0x0

    .local v15, response_id:I
    const/16 v16, 0x0

    .local v16, response_size:I
    ...
    const-string v20, "Response ID in RIL_UNSOL_OEM_HOOK_RAW is "
    ...
    const-string v20, "Response Size is Invalid "
    ...
    invoke-virtual {v0, v14, v1, v2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    const-string v20, "is not served in this process."
    ...
    const-string v19, "To broadcast an Intent via the notifier to external apps"

    invoke-static/range {v18 .. v19}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/internal/telephony/BaseCommands;->mUnsolOemHookExtAppRegistrant:Landroid/os/Registrant;
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/os/Registrant;->notifyRegistrant(Landroid/os/AsyncResult;)V

    goto :goto_0

    .end local v12           #origData:[B
    :sswitch_0
    move-object/from16 v0, p0

    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/RIL;->notifyCdmaFwdBurstDtmf([B)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/RIL;->notifyCdmaFwdContDtmfStart([B)V
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/RIL;->broadcastWifiChannelsChangedIntent([B)V
    ...
    const-string v20, "maning:stop service state = "
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/BaseCommands;->mDialupStateRegistrants:Landroid/os/RegistrantList;
...
.method static requestToString(I)Ljava/lang/String;
    ...
    :pswitch_7e
    const-string v0, "RIL_REQUEST_SET_UICC_SUBSCRIPTION_EX"
...
.method public setUiccSubscriptionEx(IIIILandroid/os/Message;)V
    .locals 3
    .parameter "slotId"
    .parameter "appIndex"
    .parameter "subId"
...
.method public writeSmsToRuim(ILjava/lang/String;Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/RIL;->mRILEx:Lcom/android/internal/telephony/RIL$RILEx;

    #calls: Lcom/android/internal/telephony/RIL$RILEx;->writeContent(Lcom/android/internal/telephony/RILRequest;Ljava/lang/String;)V
    invoke-static {v1, v0, p2}, Lcom/android/internal/telephony/RIL$RILEx;->access$1000(Lcom/android/internal/telephony/RIL$RILEx;Lcom/android/internal/telephony/RILRequest;Ljava/lang/String;)V
