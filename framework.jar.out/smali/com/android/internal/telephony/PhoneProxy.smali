...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;
    }
.end annotation
...
.field private static final GLOBAL_MODE:I = 0x4
...
.field private broadcastHelper:Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/internal/telephony/PhoneProxy;->IS_CHINA_TELECOM:Z

    new-instance v0, Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;-><init>(Lcom/android/internal/telephony/PhoneProxy;)V

    iput-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->broadcastHelper:Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/telephony/MiuiIccPhoneBookInterfaceManagerProxy;-><init>(Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/telephony/PhoneSubInfoProxy;-><init>(Lcom/android/internal/telephony/PhoneSubInfo;)V
    ...
    invoke-interface {v0, p0, v1, v4}, Lcom/android/internal/telephony/CommandsInterface;->registerForVoiceRadioTechChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/internal/telephony/Phone;->changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public getAllPnnLongName()Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getAllPnnLongName()Ljava/util/ArrayList;
...
.method public getOplPlmnlist()Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getOplPlmnlist()Ljava/util/ArrayList;
...
.method public getOplPnnNumList()Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/Phone;->getOplPnnNumList()Ljava/util/ArrayList;
...
.method protected init()V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneProxy;->broadcastHelper:Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;

    invoke-virtual {v0}, Lcom/android/internal/telephony/PhoneProxy$BroadcastHelper;->init()V

    return-void
.end method

.method public initBroadcastHelper()V
    .locals 1
...
.method public isChinaTelecom()Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/internal/telephony/PhoneProxy;->IS_CHINA_TELECOM:Z
...
.method public updatePhoneObject(I)V
    ...
    const-string v3, "newVoiceRadioTech = "
    ...
    invoke-virtual {v3, v5}, Lcom/huawei/telephony/HuaweiTelephonyManager;->getCardType(I)I
    ...
    const-string v3, ", hasActiveFgCall = "
    ...
    const-string v3, "HWNVFuncation.getPrefMode = "
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/PhoneProxy;->IS_CHINA_TELECOM:Z
    ...
    const-string v2, "sub 0 has ActiveFgCall, can not updatePhoneObject"
    ...
    const-string v3, "sub 0 cdma phone, sim application state = "
    ...
    const-string v3, " , can not updatePhoneObject"
    ...
    const-string v3, ", sub 0 sim/uim is not ready, can not updatePhoneObject"
    ...
    const-string v3, "sub 0 gsm phone, uim application state = "
    ...
    invoke-interface {v2, v5, v7}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-interface {v2, v1, v7}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/uicc/IccCardProxy;->getIccRecords()Lcom/android/internal/telephony/uicc/IccRecords;
