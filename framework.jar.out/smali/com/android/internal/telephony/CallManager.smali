...
.field private static final MAX_IN_CALL_AUDIO_MODE_BIT:I = 0x9
...
.field private static final mode2Description:[Ljava/lang/String;

.field private static final ro_config_dsda:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/CallManager;->ro_config_dsda:Z
...
.method static synthetic access$000()Z
    ...
    .prologue
    sget-boolean v0, Lcom/android/internal/telephony/CallManager;->ro_config_dsda:Z
...
.method private getEndNonIdleCall(Ljava/util/List;)Lcom/android/internal/telephony/Call;
    .locals 4
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .local v1, result:Lcom/android/internal/telephony/Call;
    ...
    .end local v1           #result:Lcom/android/internal/telephony/Call;
    check-cast v1, Lcom/android/internal/telephony/Call;

    .restart local v1       #result:Lcom/android/internal/telephony/Call;
    goto :goto_0
...
.method private inCallModeToString(I)Ljava/lang/String;
    ...
    sget-object v4, Lcom/android/internal/telephony/CallManager;->mode2Description:[Ljava/lang/String;
...
.method private phoneAudioModeForSipPhone(ILcom/android/internal/telephony/sip/SipPhone;)I
    ...
    .local v0, ret:I
    invoke-virtual {p2}, Lcom/android/internal/telephony/sip/SipPhone;->getState()Lcom/android/internal/telephony/Phone$State;
...
.method private registerForPhoneStates(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {p1, v0, v5, p1}, Lcom/android/internal/telephony/Phone;->registerForSuppServiceFailed(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {p1, v0, v5, v2}, Lcom/android/internal/telephony/Phone;->registerForSuppServiceFailed(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public getEndActiveBgCall()Lcom/android/internal/telephony/Call;
    .locals 2

    .prologue
    iget-object v1, p0, Lcom/android/internal/telephony/CallManager;->mBackgroundCalls:Ljava/util/ArrayList;

    invoke-direct {p0, v1}, Lcom/android/internal/telephony/CallManager;->getEndNonIdleCall(Ljava/util/List;)Lcom/android/internal/telephony/Call;
...
.method public getEndActiveRingingCall()Lcom/android/internal/telephony/Call;
    .locals 2
...
.method public getMute(Lcom/android/internal/telephony/Phone;)Z
    ...
    sget-boolean v2, Lcom/android/internal/telephony/CallManager;->ro_config_dsda:Z
    ...
    sget-object v3, Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;->AT_CMD_READ:Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;

    const-string v4, ""

    invoke-static {v2, v3, v4}, Lcom/huawei/atcommand/HuaweiATCmds;->huaweiATResponse(ILcom/huawei/atcommand/HuaweiATUtils$ATCmdType;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-interface {p1}, Lcom/android/internal/telephony/Phone;->getMute()Z
    ...
    const-string v3, "warning: phone is null when call getMute(Phone); then return getMute(); "

    invoke-static {v2, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getMute()Z
...
.method public setAudioAndInCallMode()V
    ...
    sget-object v6, Lcom/android/internal/telephony/CallManager$2;->$SwitchMap$com$android$internal$telephony$Phone$State:[I
...
.method public setAudioMode()V
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/CallManager;->mBaseband:Ljava/lang/String;

    const-string v7, "sglte"
    ...
    const-string v8, "setAudioMode useInCallMode = "
...
.method public setAudioMode(Lcom/android/internal/telephony/Phone;)V
    .locals 8
    .parameter "ph"
    ...
    sget-boolean v4, Lcom/android/internal/telephony/CallManager;->ro_config_dsda:Z
    ...
    const-string v6, "]AT<setAudioMode("
    ...
    const-string v6, ") getParameters(2NDMODEMDEV)="
    ...
    const-string v4, "2NDMODEMDEV=null"
    ...
    :cond_4
    const-string v4, "2NDMODEMDEV=handset"
    ...
    sget-object v4, Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;->AT_CMD_SET:Lcom/huawei/atcommand/HuaweiATUtils$ATCmdType;

    const-string v5, "1"

    invoke-static {v7, v4, v5}, Lcom/huawei/atcommand/HuaweiATCmds;->huaweiATResponse(ILcom/huawei/atcommand/HuaweiATUtils$ATCmdType;Ljava/lang/String;)Ljava/lang/Object;

    goto :goto_0

    :cond_5
    const-string v4, "2NDMODEMDEV=headset"
    ...
    :cond_6
    const-string v4, "2NDMODEMDEV=speaker"
    ...
    :cond_7
    const-string v4, "2NDMODEMDEV=btheadset"
    ...
    const-string v5, "zp:::Param remains null after 3 trials, so do nothing due to low layer not setted"
    ...
    const-string v5, "zp::: invalid value:getParameters(2NDMODEMDEV) error!!!"
...
.method public setMute(ZLcom/android/internal/telephony/Phone;)V
    .locals 3
    .parameter "muted"
    .parameter "ph"
    ...
    invoke-static {v0, v1, v2}, Lcom/huawei/atcommand/HuaweiATCmds;->huaweiATResponse(ILcom/huawei/atcommand/HuaweiATUtils$ATCmdType;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/CallManager;->setMute(Z)V
