...
.field public static final CMD_RESET_DEFAULT_APN:I = 0x42028
...
.field protected static final DIALUP_OFF:I = 0x0

.field protected static final DIALUP_ON:I = 0x1
...
.field protected static final EVENT_DIALUP_STATE_CHANGED:I = 0x64
...
.field protected mDialupState:I
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/DataConnectionTracker;->isMultiSimEnabled:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mDialupState:I
...
.method static synthetic access$000(Lcom/android/internal/telephony/DataConnectionTracker;Landroid/content/Intent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/DataConnectionTracker;->handleUsbStateChanged(Landroid/content/Intent;)V

    return-void
.end method

.method static synthetic access$100(Lcom/android/internal/telephony/DataConnectionTracker;)Ljava/lang/String;
    .locals 1
    .parameter "x0"

    .prologue
    invoke-direct {p0}, Lcom/android/internal/telephony/DataConnectionTracker;->getDataRoamingSettingItem()Ljava/lang/String;
...
.method private getDataRoamingSettingItem()Ljava/lang/String;
    .locals 2

    .prologue
    sget-boolean v1, Lcom/android/internal/telephony/DataConnectionTracker;->isMultiSimEnabled:Z
    ...
    const-string v1, "data_roaming_sim2"
...
.method private handleUsbStateChanged(Landroid/content/Intent;)V
    ...
    iget v3, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mDialupState:I

    if-ne v2, v3, :cond_0

    const/4 v2, 0x0

    iput v2, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mDialupState:I
...
.method public getDataOnRoamingEnabled()Z
    ...
    sget-boolean v4, Lcom/android/internal/telephony/DataConnectionTracker;->isMultiSimEnabled:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v9, "ro.config.cplusw.solution"
    ...
    const-string v8, "android.net.conn.MOBILE_DATA_SETTING_CHANGED"
...
.method protected notifyApnIdUpToCurrent(Ljava/lang/String;I)V
    ...
    const-string v1, "notifyApnIdUpToCurrent,reason:"
...
.method public setDataOnRoamingEnabled(Z)V
    ...
    sget-boolean v3, Lcom/android/internal/telephony/DataConnectionTracker;->isMultiSimEnabled:Z
