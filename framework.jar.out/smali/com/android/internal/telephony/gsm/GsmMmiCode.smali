...
.field static final CT_ROAMING_CALLBACK_END:Ljava/lang/String; = "#"

.field static final CT_ROAMING_CALLBACK_START:Ljava/lang/String; = "**133*86"
...
.field static final HW_OPTA:Ljava/lang/String; = null

.field static final HW_OPTB:Ljava/lang/String; = null

.field private static IS_CHINA_TELECOM:Z = false
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/internal/telephony/gsm/GsmMmiCode;->IS_CHINA_TELECOM:Z
    ...
    sput-object v0, Lcom/android/internal/telephony/gsm/GsmMmiCode;->HW_OPTA:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/internal/telephony/gsm/GsmMmiCode;->HW_OPTB:Ljava/lang/String;
...
.method private convertUssdMessage(Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    .parameter "ussdMessage"

    .prologue
    sget-object v2, Lcom/android/internal/telephony/gsm/GsmMmiCode;->HW_OPTA:Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/internal/telephony/gsm/GsmMmiCode;->HW_OPTB:Ljava/lang/String;
...
.method private static isShortCode(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;)Z
    ...
    const-string v3, "ro.config.hw_mmi_code"
    ...
    .local v0, hwMmiCodeStr:Ljava/lang/String;
    if-eqz v0, :cond_2
    ...
    .local v1, hwMmiCodes:[Ljava/lang/String;
    if-eqz v1, :cond_2
    ...
    .end local v0           #hwMmiCodeStr:Ljava/lang/String;
    .end local v1           #hwMmiCodes:[Ljava/lang/String;
    :cond_2
    invoke-virtual {p1}, Lcom/android/internal/telephony/gsm/GSMPhone;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {p0, v3}, Landroid/telephony/PhoneNumberUtils;->isLocalEmergencyNumber(Ljava/lang/String;Landroid/content/Context;)Z
...
.method private static isShortCodeUSSD(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;)Z
    ...
    invoke-static {}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->isShortCodeCustomization()Z
...
.method static newFromDialString(Ljava/lang/String;Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)Lcom/android/internal/telephony/gsm/GsmMmiCode;
    ...
    sget-boolean v2, Lcom/android/internal/telephony/gsm/GsmMmiCode;->IS_CHINA_TELECOM:Z

    if-eqz v2, :cond_0

    invoke-virtual {p1}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubscription()I
...
.method public static siToServiceClass(Ljava/lang/String;)I
    .locals 4
    .parameter "si"
...
.method sendUssd(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->convertUssdMessage(Ljava/lang/String;)Ljava/lang/String;
