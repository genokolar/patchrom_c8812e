...
.field private static final GSM_ROAMING:Ljava/lang/String; = "GSM roaming"
...
.field private static final IS_CHINATELECOM:Z = false
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mCdmaHomeOperatorNumeric:Ljava/lang/String;

    const-string v3, "persist.radio.use_nv_for_ehrpd"

    invoke-static {v3, v2}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mUseNvOperatorForEhrpd:Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINA_TELECOM:Z
    ...
    invoke-interface {v2, p0, v3, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v3, "mUseNvOperatorForEhrpd = "
...
.method private buildWaitingApns(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    #iget-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINA_TELECOM:Z
    ...
    const-string v6, "gsm.national_roaming.apn"
    ...
    const-string v7, "buildWaitingApns: use china telecom apn : true,operator="
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    if-eqz v6, :cond_4

    iget-object v6, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    invoke-virtual {v6, p1}, Lcom/android/internal/telephony/DataProfile;->canHandleType(Ljava/lang/String;)Z
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    iget-object v7, v7, Lcom/android/internal/telephony/DataProfile;->numeric:Ljava/lang/String;
    ...
    iget-object v6, v6, Lcom/android/internal/telephony/DataProfile;->numeric:Ljava/lang/String;
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    iget v6, v0, Lcom/android/internal/telephony/DataProfile;->bearer:I
...
.method private createAllApnList()V
    ...
    #iget-boolean v0, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINA_TELECOM:Z
    ...
    const-string v0, "gsm.national_roaming.apn"
    ...
    const-string v1, "createAllApnList: use china telecom apn : true,operator="
...
.method private createApnList(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    #iget-boolean v3, v0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINA_TELECOM:Z
...
.method private getOperatorNumeric()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    const-string v3, "ro.cdma.home.operator_numeric"
    ...
    const-string v5, " (mUseNvOperatorForEhrpd="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mUseNvOperatorForEhrpd:Z
    ...
    const-string v3, "IccRecords == null"
...
.method private getPreferredApn()Lcom/android/internal/telephony/DataProfile;
    ...
    const-string v0, "gsm_roming"

    invoke-static {v7, v0}, Landroid/provider/SettingsEx$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .local v6, GsmRoaming:Ljava/lang/String;
    ...
    const-string v1, "GsmRoaming status: "
    ...
    #sget-boolean v0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINATELECOM:Z
    ...
    iget-object v1, v9, Lcom/android/internal/telephony/DataProfile;->apn:Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->PREFERAPN_NO_UPDATE_URI:Landroid/net/Uri;
    ...
    iget v1, v9, Lcom/android/internal/telephony/DataProfile;->id:I
    ...
    invoke-virtual {v7, v0, v13}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;

    const-string v0, "gsm_roming"

    const-string v1, "GSM roaming"

    invoke-static {v7, v0, v1}, Landroid/provider/SettingsEx$Systemex;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    check-cast v11, Lcom/android/internal/telephony/DataProfile;

    .local v11, p:Lcom/android/internal/telephony/DataProfile;
    iget v0, v11, Lcom/android/internal/telephony/DataProfile;->id:I

    if-ne v0, v12, :cond_4

    iget-object v0, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mRequestedApnType:Ljava/lang/String;

    invoke-virtual {v11, v0}, Lcom/android/internal/telephony/DataProfile;->canHandleType(Ljava/lang/String;)Z
    ...
    .end local v10           #i$:Ljava/util/Iterator;
    .end local v11           #p:Lcom/android/internal/telephony/DataProfile;
    .end local v12           #pos:I
    :cond_5
    const/4 v0, 0x0
...
.method private isDataAllowed(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isDataAllowedForMms()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isDataAllowed(Ljava/lang/String;)Z
...
.method private isDataAllowedForMms()Z
    ...
    sget-boolean v7, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->MMS_ON_ROAMING:Z
...
.method private isForbiddenPlmns()Z
    .locals 7

    .prologue
    const/4 v2, 0x0

   # iget-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINA_TELECOM:Z
   ...
   # if-nez v3, :cond_1
    ...
    .local v1, regPlmn:Ljava/lang/String;
    if-eqz v1, :cond_0
    ...
    const-string v4, "ro.card2.custom_operator"

    const-string v5, "460-455"
    ...
    .end local v1           #regPlmn:Ljava/lang/String;
    :catch_0
    move-exception v0

    .local v0, ex:Ljava/lang/Exception;
    const-string v3, "isForbiddenPlmns: Error happens"
...
.method private onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    .prologue
    const-string v24, "onDataStateChanged(ar): E"
    ...
    const-string v24, "onDataStateChanged(ar): exception; likely radio not available, ignore"
    ...
    const-string v25, "onDataStateChanged(ar): DataCallState size="
    ...
    const-string v24, "onDataStateChanged(ar): No associated DataConnection ignore"
    ...
    const-string v24, "onDataStateChanged(ar): no connected apns"
    ...
    const-string v25, "onDataStateChanged(ar): Found ConnId="
    ...
    const-string v25, "onDataStateChanged(ar): inactive, cleanup apns="
    ...
    const-string v25, "setTetheredCallOn for apncontext:"
    ...
    const-string v24, "onDataStateChanged(ar): state is Inactive no changes"
    ...
    const-string v24, "onDataStateChanged(ar): no change"
    ...
    const-string v25, "onDataStateChanged: oldLp="
    ...
    const-string v25, "onDataStateChanged(ar): addr change, cleanup apns="
    ...
    :cond_12
    const-string v24, "onDataStateChanged(ar): simple change"
    ...
    :cond_13
    const-string v24, "onDataStateChanged(ar): no changes"
    ...
    const-string v25, "onDataStateChanged(ar): interface change, cleanup apns="
    ...
    const-string v24, "onDataStateChanged: Data Activity updated to DORMANT. stopNetStatePoll"
    ...
    const-string v25, "onDataStateChange(ar): apnsToCleanup="
    ...
    const-string v25, "onDataStateChanged: Data Activity updated to NONE. isAnyDataCallActive = "
    ...
    .restart local v15       #i$:Ljava/util/Iterator;
    :cond_19
    const-string v24, "onDataStateChanged(ar): X"
...
.method private setupDataOnReadyApns(Ljava/lang/String;)V
    ...
    const-string v11, "setupDataOnReadyApns: "
    ...
    invoke-virtual {v10}, Landroid/telephony/MSimTelephonyManager;->getMmsAutoSetDataSubscription()I

    move-result v9

    .local v9, mmsSetSub:I
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/DataConnectionAc;->getReconnectIntentSync()Landroid/app/PendingIntent;

    move-result-object v10

    if-eqz v10, :cond_1

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cancelReconnectAlarm(Lcom/android/internal/telephony/DataConnectionAc;)V
    ...
    invoke-direct {p0, v10, v5, v12}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->configureRetry(Lcom/android/internal/telephony/DataConnection;ZI)V
    ...
    new-array v11, v12, [Lcom/android/internal/telephony/ApnContext;
    ...
    .local v3, arr$:[Lcom/android/internal/telephony/ApnContext;
    array-length v8, v3
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/telephony/ApnContext;->setState(Lcom/android/internal/telephony/DataConnectionTracker$State;)V
    ...
    .local v1, apnTypeStr:Ljava/lang/String;
    ...
    .end local v1           #apnTypeStr:Ljava/lang/String;
    :cond_7
    :goto_2
...
.method private trySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isForbiddenPlmns()Z
    ...
    const-string v3, "trySetupData context: not allow to enable data connection when not mms"
    ...
    sget-boolean v4, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->SUPPORT_MPDN:Z
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isAnyActiveApnContextHandlesType(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->disconnectOneLowerPriorityCall(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isHigherPriorityDataCallActive(Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->MMS_ON_ROAMING:Z
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->buildWaitingApns(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, p1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->notifyNoData(Lcom/android/internal/telephony/DataConnection$FailCause;Lcom/android/internal/telephony/ApnContext;)V

    invoke-virtual {p1}, Lcom/android/internal/telephony/ApnContext;->getReason()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->notifyOffApnsOfAvailability(Ljava/lang/String;)V
...
.method private trySetupData(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v1, "trySetupData: not allow to enable data connection when not mms"
...
.method protected cleanUpAllConnections(ZLjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0, v2}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;Z)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-boolean v1, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIsDisposed:Z
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIsPsRestricted:Z
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cleanUpAllConnections(ZLjava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;Z)V
...
.method protected isDataAllowed()Z
    ...
    :cond_0
    iget-boolean v9, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mUseNvOperatorForEhrpd:Z

    if-eqz v9, :cond_1

    if-ne v5, v11, :cond_1

    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mCdmaHomeOperatorNumeric:Ljava/lang/String;
    ...
    :cond_5
    iget-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mUseNvOperatorForEhrpd:Z

    if-eqz v8, :cond_6

    if-ne v5, v11, :cond_6

    iget-object v8, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mCdmaHomeOperatorNumeric:Ljava/lang/String;
    ...
    const-string v9, " - Cdma Home Operator Numeric not available"
...
.method protected isDataAllowed(Ljava/lang/String;)Z
    .locals 12
    .parameter "dataAllowedReason"
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    #sget-boolean v12, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->IS_CHINATELECOM:Z
    ...
    const-string v12, "10.0.0.200"

    invoke-virtual {v10}, Landroid/net/ProxyProperties;->getHost()Ljava/lang/String;
    ...
    :cond_4
    const-string v12, "not china telecom gsm roaming, set ctwap proxy"
...
.method protected onResetApn()V
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/telephony/ApnContext;->setDependencyMet(Z)V
...
.method protected onVoiceCallEnded()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->onCleanUpAllConnections(Ljava/lang/String;)V
