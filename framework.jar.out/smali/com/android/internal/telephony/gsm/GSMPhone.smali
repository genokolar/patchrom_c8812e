...
.method public changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-interface {v1, v0, p1, p2, p3}, Lcom/android/internal/telephony/CommandsInterface;->changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public getAllPnnLongName()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/SIMRecords;->getAllPnnLongName()Ljava/util/ArrayList;
...
.method public getCallForwardingIndicator()Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/uicc/IccRecords;->getVoiceCallForwardingFlag()Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/uicc/IccRecords;->getVoiceCallForwardingFlagSim()Z
...
.method public getCallbarringOption(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    .local v0, serviceClassFlag:I
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mCM:Lcom/android/internal/telephony/CommandsInterface;

    const-string v2, ""

    invoke-interface {v1, p1, v2, v0, p3}, Lcom/android/internal/telephony/CommandsInterface;->queryFacilityLock(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Message;)V
...
.method public getOplPlmnlist()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/SIMRecords;->getOplPlmnlist()Ljava/util/ArrayList;
...
.method public getOplPnnNumList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/SIMRecords;->getOplPnnNumList()Ljava/util/ArrayList;
...
.method public getVoiceMailAlphaTag()Ljava/lang/String;
    ...
    :goto_0
    sget-boolean v2, Lcom/android/internal/telephony/gsm/GSMPhone;->HW_VM_NOT_FROM_SIM:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v7}, Lcom/android/internal/telephony/gsm/GSMPhone;->setVmSimImsi(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/gsm/GSMPhone;->updateCallForwardStatus(I)V

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/telephony/PhoneBase;->mSimRecordsLoadedRegistrants:Landroid/os/RegistrantList;
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/PhoneBase;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v11, v15, v14, v0}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    invoke-static {v10, v14, v15}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    iget-object v14, v14, Lcom/android/internal/telephony/ServiceStateTracker;->ss:Landroid/telephony/ServiceState;
    ...
    const-string v15, "Stop duplicate SET_NETWORK_SELECTION_AUTOMATIC to Ril "
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/gsm/GSMPhone;->handleSetSelectNetwork(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v14, v15}, Lcom/android/internal/telephony/uicc/SIMRecords;->getEonsForAvailableNetworks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    const-string v15, "getEonsForAvailableNetworks() aborted. icc absent?"
    ...
    invoke-static {v10, v4, v14}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    invoke-direct {v8, v0, v14}, Lcom/android/internal/telephony/gsm/GsmMmiCode;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;Lcom/android/internal/telephony/uicc/UiccCardApplication;)V
...
.method public setCallWaiting(ZLandroid/os/Message;)V
    ...
    .prologue
    const-string v0, "ro.config.hw_cw_service_class"
    ...
    const-string v1, "disable CallWaiting all class =0"
...
.method public setCallbarringOption(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Landroid/os/Message;)V
    ...
    .prologue
    invoke-static {p4}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->siToServiceClass(Ljava/lang/String;)I

    move-result v4

    .local v4, serviceClassFlag:I
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mCM:Lcom/android/internal/telephony/CommandsInterface;
