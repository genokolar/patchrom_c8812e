...
.method static synthetic access$4400(Landroid/media/AudioService$VolumeStreamState;)Ljava/util/concurrent/ConcurrentHashMap;
    .locals 1
    .parameter "x0"
...
.method public declared-synchronized applyAllVolumes()V
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$3900(Landroid/media/AudioService;)Z
...
.method public declared-synchronized setAllIndexes(Landroid/media/AudioService$VolumeStreamState;Z)V
    ...
    invoke-static {v6, v3, v7, v8}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;III)I
...
.method public declared-synchronized setLastAudibleIndex(II)V
    ...
    #calls: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v4, v5}, Landroid/media/AudioService;->access$4100(Landroid/media/AudioService;I)I
    ...
    #calls: Landroid/media/AudioService;->rescaleIndex(III)I
    invoke-static {v4, p1, v5, v3}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;III)I
    ...
    #getter for: Landroid/media/AudioService;->mStreamStates:[Landroid/media/AudioService$VolumeStreamState;
    invoke-static {v4}, Landroid/media/AudioService;->access$4300(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
    ...
    #calls: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v5, v3}, Landroid/media/AudioService;->access$4100(Landroid/media/AudioService;I)I
