...
.method private persistVolume(Landroid/media/AudioService$VolumeStreamState;II)V
    ...
    invoke-virtual {p1, v5, p3}, Landroid/media/AudioService$VolumeStreamState;->getSettingNameForDevice(ZI)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1, p3, v5}, Landroid/media/AudioService$VolumeStreamState;->getIndex(IZ)I
    ...
    const-string v1, "persist.sys.ring.index"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v2}, Landroid/media/AudioService$AudioHandler;->hasMessages(I)Z
    ...
    #setter for: Landroid/media/AudioService;->mRecordVolume:I
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$7102(Landroid/media/AudioService;I)I
    ...
    #setter for: Landroid/media/AudioService;->mEarPhoneOn:Z
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$3902(Landroid/media/AudioService;Z)Z
    ...
    #setter for: Landroid/media/AudioService;->mLastRecordTime:J
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$7302(Landroid/media/AudioService;J)J
    ...
    invoke-static {v1, v2, v3, v4}, Landroid/media/AudioService;->access$7400(Landroid/media/AudioService;IJ)V
    ...
    #calls: Landroid/media/AudioService;->hasEarPhoneConnected()Z
    ...
    invoke-virtual {v1, v2}, Landroid/media/AudioService$AudioHandler;->removeMessages(I)V
    ...
    #calls: Landroid/media/AudioService;->updateEarPhonePlugTime()V
    ...
    #calls: Landroid/media/AudioService;->createCEWarningDialog()Landroid/app/AlertDialog;
    invoke-static {v2}, Landroid/media/AudioService;->access$7900(Landroid/media/AudioService;)Landroid/app/AlertDialog;

    move-result-object v2

    #setter for: Landroid/media/AudioService;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$7802(Landroid/media/AudioService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;

    move-object/from16 v0, p0

    iget-object v1, v0, Landroid/media/AudioService$AudioHandler;->this$0:Landroid/media/AudioService;

    #getter for: Landroid/media/AudioService;->mAlertDialog:Landroid/app/AlertDialog;
    invoke-static {v1}, Landroid/media/AudioService;->access$7800(Landroid/media/AudioService;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$7702(Landroid/media/AudioService;Z)Z
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8000(Landroid/media/AudioService;)Landroid/app/NotificationManager;
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$8100(Landroid/media/AudioService;)Landroid/content/Context;
