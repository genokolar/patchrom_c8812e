...
.field public static final SOFTAP_IFACE:Ljava/lang/String; = "eth0"
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->startChannel:I

    const/4 v6, 0x0

    iput v6, p0, Landroid/net/wifi/WifiStateMachine;->endChannel:I
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mUpdateV6Addresses:Z

    const-string v6, "persist.wifi.v6"
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mWifiV6Supported:Z
    ...
    const-string v6, "android.intent.action.SAFE_WIFI_CHANNELS_CHANGED"
    ...
    const-string v9, "android.intent.action.SAFE_WIFI_CHANNELS_CHANGED"
    ...
    new-instance v6, Landroid/net/wifi/WifiStateMachine$4;

    invoke-direct {v6, p0}, Landroid/net/wifi/WifiStateMachine$4;-><init>(Landroid/net/wifi/WifiStateMachine;)V
    ...
    iget-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mWifiV6Supported:Z

    if-eqz v6, :cond_0

    new-instance v2, Landroid/content/Intent;

    const-string v6, "android.net.wifi.IPV6_RENEW"

    invoke-direct {v2, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v2, ipv6RenewalIntent:Landroid/content/Intent;
    iget-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mContext:Landroid/content/Context;
    ...
    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mIpv6RenewalIntent:Landroid/app/PendingIntent;
    ...
    const-string v9, "android.net.wifi.IPV6_RENEW"

    invoke-direct {v8, v9}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    invoke-virtual {v6, v7, v8}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .end local v2           #ipv6RenewalIntent:Landroid/content/Intent;
    :cond_0
...
.method static synthetic access$10000(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/IState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$10302(Landroid/net/wifi/WifiStateMachine;Ljava/util/List;)Ljava/util/List;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12200(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpInfoInternal;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$14200(Landroid/net/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$14300(Landroid/net/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$14500(Landroid/net/wifi/WifiStateMachine;)Landroid/net/ConnectivityManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$15402(Landroid/net/wifi/WifiStateMachine;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16200(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$16300(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$17200(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7600(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)Landroid/net/wifi/SupplicantState;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8600(Landroid/net/wifi/WifiStateMachine;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9200(Landroid/net/wifi/WifiStateMachine;)Landroid/content/BroadcastReceiver;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9300(Landroid/net/wifi/WifiStateMachine;)Landroid/content/IntentFilter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9400(Landroid/net/wifi/WifiStateMachine;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9500(Landroid/net/wifi/WifiStateMachine;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9608(Landroid/net/wifi/WifiStateMachine;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$9700(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9702(Landroid/net/wifi/WifiStateMachine;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$9900(Landroid/net/wifi/WifiStateMachine;)Landroid/app/AlarmManager;
    .locals 1
    .parameter "x0"
...
.method private configureLinkProperties()V
    ...
    const-string v1, "persist.wifi.v6:"
    ...
    const-string v0, "Need to update V6 addresses"

    invoke-direct {p0, v0}, Landroid/net/wifi/WifiStateMachine;->log(Ljava/lang/String;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/net/wifi/WifiStateMachine;->mUpdateV6Addresses:Z
...
.method private updateV6Addresses(Landroid/net/LinkProperties;)V
    ...
    const-string v14, "updateV6Addresses(): linkProperties="
    ...
    const-string v14, "retrieving gateway for :"
